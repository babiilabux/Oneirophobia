...
import {
  Light,
  SpotLight
} from "./chunk-QBVVNEQ7.js";
import {
  Bone
} from "./chunk-HZXXKJYK.js";
import {
  getAnimationTypeByFlowGraphType
} from "./chunk-QNTHIMQR.js";
import {
  RenderTargetTexture,
  SphericalHarmonics,
  SphericalPolynomial
} from "./chunk-376V6KTI.js";
import {
  AbstractMesh,
  BoundingInfo,
  Material,
...
var GLTFLoader2 = class _GLTFLoader {
  ...
  loadAnimationAsync(context, animation) {
    ...
    return import("./animationGroup-XR33Q5EF.js").then(({ AnimationGroup }) => {
      this._babylonScene._blockEntityCollection = !!this._assetContainer;
  ...
  async _loadAnimationChannelAsync(context, animationContext, animation, channel, onLoad) {
    ...
    await import("./glTFLoaderAnimation-Y7IMXNBK.js");
    let properties;
...
addToBlockFactory(NAME32, "FlowGraphGLTFDataProvider", async () => {
  return (await import("./flowGraphGLTFDataProvider-TVPFMBRK.js")).FlowGraphGLTFDataProvider;
});
...
//# sourceMappingURL=chunk-T5ETOLD5.js.map
