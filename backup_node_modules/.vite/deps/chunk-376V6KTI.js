import {
  ...
  RenderingManager,
  SmartArray
} from "./chunk-SPI7UZDI.js";
import {
  EffectWrapper
} from "./chunk-WJMMKYZG.js";
import {
  PerfCounter
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-REWIRDO7.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-B2BDCN45.js");
    const textures = [];
...
//# sourceMappingURL=chunk-376V6KTI.js.map
